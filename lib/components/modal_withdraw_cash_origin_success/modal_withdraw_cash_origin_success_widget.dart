...
import 'modal_withdraw_cash_origin_success_model.dart';
export 'modal_withdraw_cash_origin_success_model.dart';

class ModalWithdrawCashOriginSuccessWidget extends StatefulWidget {
  const ModalWithdrawCashOriginSuccessWidget({
    Key? key,
    this.name,
  }) : super(key: key);
  ...
  @override
  _ModalWithdrawCashOriginSuccessWidgetState createState() =>
      _ModalWithdrawCashOriginSuccessWidgetState();
}

class _ModalWithdrawCashOriginSuccessWidgetState
    extends State<ModalWithdrawCashOriginSuccessWidget> {
  late ModalWithdrawCashOriginSuccessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalWithdrawCashOriginSuccessModel());
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    wrapWithModel(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        title:
                                                                            'Interest payment',
                                                                        subTitle:
                                                                            functions.timeInterestPayment(getJsonField(
                                                                          containerGetPackageInvestmentResponse
                                                                              .jsonBody,
                                                                          r'''$.data[0].list_attr[0].time_range''',
                                                                        ).toString()),
                                                                    ...
                                                                    wrapWithModel(
                                                                      ...
                                                                      child:
                                                                          TotalGroupItemWidget(
                                                                        title: functions
                                                                            .possibleWithdrawCashOrigin(getJsonField(
                                                                          containerGetPackageInvestmentResponse
                                                                              .jsonBody,
                                                                          r'''$.data[0].list_attr[0].time_range''',
                                                                        ).toString()),

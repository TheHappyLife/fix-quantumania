  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[
      ...
      serializers.serialize(object.item,
          specifiedType: const FullType(NotificationStruct)),
    ];
    Object? value;
    value = object.ffRef;
    if (value != null) {
...
class _$NotificationsRecord extends NotificationsRecord {
  ...
  _$NotificationsRecord._({required this.item, this.ffRef}) : super._() {
    BuiltValueNullFieldError.checkNotNull(item, r'NotificationsRecord', 'item');
  }
...
class NotificationsRecordBuilder
  ...
  NotificationStructBuilder? _item;
  NotificationStructBuilder get item =>
      _$this._item ??= new NotificationStructBuilder();
  set item(NotificationStructBuilder? item) => _$this._item = item;
  ...
  _$NotificationsRecord _build() {
    ...
    try {
      _$result =
          _$v ?? new _$NotificationsRecord._(item: item.build(), ffRef: ffRef);
    } catch (_) {

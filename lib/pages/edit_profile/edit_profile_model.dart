...
class EditProfileModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (API Update Profile)] action in Button widget.
  ApiCallResponse? responseProfile;
  // Stores action output result for [Backend Call - API (API Profile)] action in Button widget.

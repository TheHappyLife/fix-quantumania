...
import 'withdraw_transaction_model.dart';
export 'withdraw_transaction_model.dart';

class WithdrawTransactionWidget extends StatefulWidget {
  const WithdrawTransactionWidget({Key? key}) : super(key: key);

  @override
  _WithdrawTransactionWidgetState createState() =>
      _WithdrawTransactionWidgetState();
}

class _WithdrawTransactionWidgetState extends State<WithdrawTransactionWidget> {
  late WithdrawTransactionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WithdrawTransactionModel());

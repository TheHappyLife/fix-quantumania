...
import 'aff_statistic_update_model.dart';
export 'aff_statistic_update_model.dart';

class AffStatisticUpdateWidget extends StatefulWidget {
  const AffStatisticUpdateWidget({
    Key? key,
    this.subTitle,
  }) : super(key: key);
  ...
  @override
  _AffStatisticUpdateWidgetState createState() =>
      _AffStatisticUpdateWidgetState();
}

class _AffStatisticUpdateWidgetState extends State<AffStatisticUpdateWidget> {
  late AffStatisticUpdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AffStatisticUpdateModel());
              ...
              children: [
                Row(
                  ...
                  children: [
                    InkWell(
                      onTap: () async {
                        context.pushNamed('Withdraw-castout');
                      },
                      child: Text(
                        'go ro cast out',

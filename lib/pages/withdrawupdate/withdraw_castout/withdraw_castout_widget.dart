...
import 'withdraw_castout_model.dart';
export 'withdraw_castout_model.dart';

class WithdrawCastoutWidget extends StatefulWidget {
  const WithdrawCastoutWidget({
    Key? key,
    this.loadingWallet,
  }) : super(key: key);
  ...
  @override
  _WithdrawCastoutWidgetState createState() => _WithdrawCastoutWidgetState();
}

class _WithdrawCastoutWidgetState extends State<WithdrawCastoutWidget> {
  late WithdrawCastoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WithdrawCastoutModel());

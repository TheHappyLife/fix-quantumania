...
import 'modal_my_investment_success_model.dart';
export 'modal_my_investment_success_model.dart';

class ModalMyInvestmentSuccessWidget extends StatefulWidget {
  const ModalMyInvestmentSuccessWidget({
    Key? key,
    this.name,
  }) : super(key: key);
  ...
  @override
  _ModalMyInvestmentSuccessWidgetState createState() =>
      _ModalMyInvestmentSuccessWidgetState();
}

class _ModalMyInvestmentSuccessWidgetState
    extends State<ModalMyInvestmentSuccessWidget> {
  late ModalMyInvestmentSuccessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalMyInvestmentSuccessModel());
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              'Recommended investment: high returns in a short time',
                                                              textAlign:
                                                                  TextAlign
                                                                      .start,

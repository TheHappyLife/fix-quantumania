...
import 'modal_filter_model.dart';
export 'modal_filter_model.dart';

class ModalFilterWidget extends StatefulWidget {
  const ModalFilterWidget({Key? key}) : super(key: key);

  @override
  _ModalFilterWidgetState createState() => _ModalFilterWidgetState();
}

class _ModalFilterWidgetState extends State<ModalFilterWidget> {
  late ModalFilterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalFilterModel());

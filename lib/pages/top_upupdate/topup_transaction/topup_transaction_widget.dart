...
import 'topup_transaction_model.dart';
export 'topup_transaction_model.dart';

class TopupTransactionWidget extends StatefulWidget {
  const TopupTransactionWidget({Key? key}) : super(key: key);

  @override
  _TopupTransactionWidgetState createState() => _TopupTransactionWidgetState();
}

class _TopupTransactionWidgetState extends State<TopupTransactionWidget> {
  late TopupTransactionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopupTransactionModel());

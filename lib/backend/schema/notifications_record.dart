...
abstract class NotificationsRecord
  ...
  static void _initializeBuilder(NotificationsRecordBuilder builder) =>
      builder..item = NotificationStructBuilder();
...
Map<String, dynamic> createNotificationsRecordData({
  NotificationStruct? item,
}) {
  final firestoreData = serializers.toFirestore(
    NotificationsRecord.serializer,
    NotificationsRecord(
      (n) => n..item = NotificationStructBuilder(),
    ),
  );

  // Handle nested data for "item" field.
  addNotificationStructData(firestoreData, item, 'item');
